...
<body>
	...
	<fieldset>
		<legend>로그인</legend>
		<form action="ex66_result.jsp">
			<%-- required : 필수 입력란이 된다. 입력을 하지 않으면 전송 버튼이 실행되지 않음 --%>
			...
			<%-- checkbox값 : 복수 선택지를 성생, value안의 값이 전달된다 --%>
			<p>
				...
				<input name="hobby" type="checkbox" value="exercise">운동
			</p>
